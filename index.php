                ...
                <div id="columns01" class="container default">
                    <div class="wrapper">
                        <div class="inner">
                            ...
                            <a href="jadwalutama.php" data-role="button" class="buttons" data-inline="true">
                                <button
                                    onclick="return confirm('Apakah anda yakin untuk mengubah jadwal yang sedang ada')"
                                    type="button" class="buttons">Ciptakan Jadwal Umum</button>
                            </a>
                        ...
                        <table>
                            <thead>
                                <tr>
                                    ...
                                    <th>Sound</th>
                                    <th>Aksi</th>
                                    <th><a href="tambah_jadwal.php?ishari=<?php echo $pilihanHari?>">Tambah
                                            Jadwal</a>
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="edit_jadwal.php?id=<?php echo $data['id'] ?>">
                                            Edit
                                        </a>
                                    </td>
                                    <td>
